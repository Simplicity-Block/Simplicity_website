    ...
    <div className="min-h-screen bg-black">
      ...
      <div className="max-w-7xl mx-auto px-8 py-16">
        <div className="grid grid-cols-1 gap-8">
          ...
          <div className="max-w-7xl mx-auto px-8 py-16">
        <div className="grid grid-cols-1 gap-8">
          {/* Add new Transfer Operations card before the IDE Features card */}
          <Card className="bg-black/40 backdrop-blur-xl border border-purple-500/20">
            <CardHeader>
              <CardTitle className="text-2xl text-white">Transfer Operations</CardTitle>
              <CardDescription className="text-white/60">
                Learn how to handle money transfers securely using Simply-lang smart contracts
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div className="lg:col-span-2">
                  <div className="space-y-4">
                    <h3 className="text-lg font-medium text-white">Wallet Contract with Transfer Function</h3>
                    <pre className="bg-black/40 p-4 rounded-lg overflow-x-auto">
...
.`}</code>
                ...
                <div className="space-y-6">
                  <div className="bg-black/40 rounded-xl p-6 border border-purple-500/10">
                    ...
                    <ul className="space-y-3 text-white/60 text-sm">
                      <li>• Built-in balance tracking</li>
                      <li>• Automatic safety checks</li>
                      <li>• Direct transfer operations</li>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
                <div className="bg-black/40 rounded-xl p-6 border border-purple-500/10 hover:border-purple-500/30 transition-all">
                  <h4 className="text-lg font-medium text-white mb-3">Deposit</h4>
                  <p className="text-white/60 text-sm mb-4">Add funds to the contract balance using the deposit function</p>
                  <pre className="bg-black/60 p-3 rounded-lg">
                    <code className="text-purple-400 text-sm">deposit(amount: 100)</code>
                  </pre>
                </div>

                <div className="bg-black/40 rounded-xl p-6 border border-purple-500/10 hover:border-purple-500/30 transition-all">
                  <h4 className="text-lg font-medium text-white mb-3">Withdraw</h4>
                  <p className="text-white/60 text-sm mb-4">Safely withdraw funds with balance verification</p>
                  <pre className="bg-black/60 p-3 rounded-lg">
                    <code className="text-purple-400 text-sm">withdraw(amount: 50)</code>
                  </pre>
                </div>

                <div className="bg-black/40 rounded-xl p-6 border border-purple-500/10 hover:border-purple-500/30 transition-all">
                  <h4 className="text-lg font-medium text-white mb-3">Transfer</h4>
                  <p className="text-white/60 text-sm mb-4">Send funds directly to another address</p>
                  <pre className="bg-black/60 p-3 rounded-lg">
                    <code className="text-purple-400 text-sm">transfer_to(amount: 75, address: "recipient")</code>
                  </pre>
                </div>
              </div>

              <div className="mt-8 p-6 bg-purple-500/10 rounded-xl border border-purple-500/20">
                <h4 className="text-lg font-medium text-white mb-4">Security Considerations</h4>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <ul className="space-y-2 text-white/60">
                    <li>• Always verify balance before transfers</li>
                    <li>• Check recipient address format</li>
                    <li>• Use proper error handling</li>
                  </ul>
                  <ul className="space-y-2 text-white/60">
                    <li>• Implement access controls</li>
                    <li>• Consider gas fees</li>
