    ...
    <section className="py-32 relative">
      <div className="max-w-7xl mx-auto px-8">
        ...
        <div className="relative">
          {/* Connecting line */}
          <div className="absolute left-1/2 top-0 bottom-0 w-px bg-gradient-to-b from-purple-500 to-blue-500 opacity-20" />
          
          <div className="space-y-32">
            {/* Step 1 */}
            <div 
              ref={stepRefs[0]}
              className="relative grid grid-cols-1 lg:grid-cols-2 gap-16 items-center opacity-0 transform translate-y-8 transition-all duration-1000"
            >
