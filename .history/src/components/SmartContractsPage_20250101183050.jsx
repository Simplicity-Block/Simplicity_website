              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="flex items-center space-x-4 p-4 rounded-lg bg-purple-500/10">
                    ...
                    <button href="https://simplicity-ide.web.app/" className="ml-auto px-4 py-2 rounded-full bg-purple-500/20 text-purple-400 hover:bg-purple-500/30 transition-all">
                      Try IDE
                    </button>
                  </div>
                </div>
